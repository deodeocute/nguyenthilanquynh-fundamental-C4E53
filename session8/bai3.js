...
const    quoteText = document.getElementById("a")
const    quoteAuthor = document.getElementById("b")
const reload = document.getElementById("reload")
    
let ran = quote[Math.floor(Math.random() * quote.length) ]
    quoteText.innerHTML=ran.quoteText
    quoteAuthor.innerText = ran.quoteAuthor
    
reload.addEventListener('click' , ()=>{
    let ran2 = quote[Math.floor(Math.random() * quote.length) ]
    quoteText.innerHTML=ran2.quoteText    
    quoteAuthor.innerText = ran2.quoteAuthor 
})
