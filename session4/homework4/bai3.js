...
// 3.1 : Object
// 3.2 : values hits la Array
console.log(jobSearch.hits)
let job = jobSearch.hits
console.log(job[0])
for(i = 0 ; i < job.length ; i ++){
    // console.log(job[i])
    // console.log(job[i].jobTitle)
    // console.log(job[i].locations)
    // console.log(job[i].locations[0])
    // console.log(job[i].jobSalary)
    // let benefits = job[i].benefits
    // benefits.forEach((v,i)=>{
    //     console.log(`${v.benefitIconName} ${v.benefitId} ${v.benefitIconName} ${v.benefitValue}`)
    // })
    // console.log(job[i].benefits)
    console.log(job[i].skills)
    let skill = job[i].skills
    skill.forEach((v,i)=>{
        console.log(`${skill[i]}`)
    })
     console.log(job[i].jobRequirement)
}